    ...
    <section id="services" className="py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <span className="bg-henry-yellow text-henry-navy text-sm font-bold uppercase px-4 py-1 rounded-full mb-4 inline-block">Our Specialties</span>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {services.map((service, index) => (
            <div key={index} className="service-card">
              <div className="icon-wrapper bg-henry-navy text-henry-yellow p-4 rounded-full w-16 h-16 flex items-center justify-center mb-6 transition-colors">
        ...
        <div className="mt-16 bg-henry-navy rounded-xl p-8 shadow-xl">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              <h3 className="text-2xl font-bold text-white mb-4">Why Choose Ductless Systems?</h3>
              <ul className="space-y-3">
                {[
                  ...
                  <li key={i} className="flex items-start">
                    <div className="bg-henry-yellow rounded-full p-1 mr-3 mt-1">
            ...
            <div className="bg-white p-6 rounded-lg">
              <h4 className="font-bold text-xl text-henry-navy mb-4">Get a Free Consultation</h4>
