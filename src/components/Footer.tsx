        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#financing" className="text-gray-300 hover:text-henry-yellow">Financing</a></li>
              <li><a href="#contact" className="text-gray-300 hover:text-henry-yellow">Contact</a></li>
              <li><a href="/dictionary" className="text-gray-300 hover:text-henry-yellow">Dictionary</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-center">
                ...
                <a href="mailto:hello@thehenrybros.com" className="text-gray-300 hover:text-henry-yellow">hello@thehenrybros.com</a>
              </li>
              <li className="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-henry-yellow mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
